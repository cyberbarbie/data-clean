...
Erick Harper ;,;$17.41;,; pink ;,; 09/15/17, 
...
# Iterate through sales and for each item
# strip off the $
# set it equal to a float, 
# add to total_sales
total_sales = 0

for sale in sales:
  sale = float(sale.strip(" ").strip("$")) 
  total_sales += sale
#print(total_sales)
...
#The function should iterate through thread_sold_split and
# count the number of times the item is equal to argument, color
